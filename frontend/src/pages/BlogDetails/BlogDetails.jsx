    ...
    return (
      <div className="blog-details-main-container">
        <div className="blog-details-container">
          ...
          <div className="blog-details-main-image-box" onClick={() => setSelectedImage(blog.thumbnails)} style={{ cursor: "pointer" }}>
            {/* onClick={() => setSelectedImage(blog.thumbnails)} */}
            {/* style={{ cursor: "pointer" }} */}
            <img src={blog.thumbnails} alt="Blog-image" />
          </div>
          ...
          {/*Pop for Image Preview */}
          <Dialog visible={!!selectedImage} onHide={() => setSelectedImage(null)} header={null} style={{ width: "80vw", maxWidth: "800px" }} dismissableMask>
            <img src={selectedImage} alt="Preview" style={{ width: "100%", height: "auto", borderRadius: "0.5em" }} />
          </Dialog>
          <div className="blog-details-blog-like-dislike-prev-next-box">
            <div className="blog-details-blog-like-dislike-box">
              <div className="blog-details-blog-like-box">
                <button
                  className="blog-details-blog-like-button"
                  onClick={handleLike}
                >
                  {/* <ThumbUpAltOutlinedIcon /> */}
                  {liked ? <ThumbUpAltIcon /> : <ThumbUpAltOutlinedIcon />}
                </button>
                <span className="blog-details-blog-like-count">
                  {likeCount}
                </span>
              </div>
              <div className="blog-details-blog-dislike-box">
                <button
                  className="blog-details-blog-dislike-button"
                  onClick={handleDislike}
                >
                  {/* <ThumbDownOutlinedIcon /> */}
                  {disliked ? <ThumbDownIcon /> : <ThumbDownOutlinedIcon />}
                </button>
                <span className="blog-details-blog-dislike-count">
                  {dislikeCount}
                </span>
              </div>
            </div>
